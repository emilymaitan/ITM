  ...
  <body data-spy="scroll" data-target=".navbar" data-offset="50">
      ...
      <div class="page-container">
          <div class="container">
            ...
            <h1 class="page-header">Media that is tagged with <%= tag %></h1>
            ...
            <%
              ...
              <% // handle images
                  ...
                  if ( medium instanceof ImageMedia ) {
                      ...
                      if (firstImage) {
                          firstImage = false;
              %>
              <h2 id ="images" class="page-header">Tagged Images</h2>
              <%
                  } // endif first image
              %>
              ...
              <% } else if ( medium instanceof AudioMedia ) {
                  ...
                  if (firstAudio) {
                      firstAudio = false;
              %>
              <h2 id ="audio" class="page-header"> Tagged Audios</h2>
              <%
                  }
              %>
              ...
              %>
              <h2 id="video" class="page-header">Tagged Videos</h2>
              <%
                  }
              %>
